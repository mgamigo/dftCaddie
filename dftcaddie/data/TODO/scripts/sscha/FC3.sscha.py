...
dyn_start = CC.Phonons.Phonons("sscha/data_ensemble/dyn_gen_pop"+str(N_pop)+"_", nqirr =num_q)
dyn_end = CC.Phonons.Phonons("sscha/dyn_end_population"+str(N_pop)+"_", nqirr =num_q)
supercell = dyn_end.GetSupercell()
tensor3 = CC.ForceTensor.Tensor3(dyn_end.structure,dyn_end.structure.generate_supercell(supercell),supercell)
...
tensor3.Apply_ASR()
# Print it
tensor3.WriteOnFile(fname="FC3/FC3",file_format='D3Q')
